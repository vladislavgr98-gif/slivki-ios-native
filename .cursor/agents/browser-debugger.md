...
description: "Use when a task needs browser-based reproduction, UI evidence gathering, or client-side debugging through a browser MCP server. Use proactively when matching native UI to the live mobile website and gathering DOM/screenshot evidence."
---
...
- Reference URLs: /shop, product pages, cart, profile/login
- Capture evidence before proposing UI diffs
- Do not treat site HTML as runtime for native app
